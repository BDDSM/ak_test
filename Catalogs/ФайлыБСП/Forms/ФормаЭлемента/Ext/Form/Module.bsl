...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//+++АК LAGP 2018.03.13 ИП-00018042 Нет модуля "Пользователи"
	...
	//УправлениеСвойствами.ПриСозданииНаСервере(ЭтаФорма, Объект, "");  //+++АК LAGP 2018.03.13 ИП-00018042 Нет такого модуля
	...
	//+++АК LAGP 2018.03.13 ИП-00018042 Нет такого справочника
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	// СтандартныеПодсистемы.Свойства
	//Если УправлениеСвойствамиКлиент.ОбрабатыватьОповещения(ЭтаФорма, ИмяСобытия, Параметр) Тогда   //+++АК LAGP 2018.03.13 ИП-00018042 Нет такого модуля
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект)
	...
	// СтандартныеПодсистемы.Свойства
	//УправлениеСвойствами.ПередЗаписьюНаСервере(ЭтаФорма, ТекущийОбъект); //+++АК LAGP 2018.03.13 ИП-00018042 Нет такого модуля
	// Конец СтандартныеПодсистемы.Свойства
...
Процедура Подключаемый_РедактироватьСоставСвойств()
	...
	//УправлениеСвойствамиКлиент.РедактироватьСоставСвойств(ЭтаФорма, Объект.Ссылка); //+++АК LAGP 2018.03.13 ИП-00018042 Нет такого модуля
...
Процедура ОбновитьЭлементыДополнительныхРеквизитов()
	...
	//УправлениеСвойствами.ОбновитьЭлементыДополнительныхРеквизитов(ЭтаФорма, РеквизитФормыВЗначение("Объект")); //+++АК LAGP 2018.03.13 ИП-00018042 Нет такого модуля
