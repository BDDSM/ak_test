...
Процедура ЗаполнитьРолиОтветственных()
	...
	ТЗ = "ВЫБРАТЬ РАЗЛИЧНЫЕ
	     ...
	     |	РолиПользователей.Ссылка.Представление КАК Наименование,
	     |	ВЫБОР
...
Процедура ТипРозничнойТочкиНачалоВыбораИзСписка(Элемент, СтандартнаяОбработка) //+++АК mika 2018.02.20 ИП-00017929
	...
	Элементы.ТипРозничнойТочки.СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ТипыРозничныхТочек.ПространствоВкусвилл"));
	//---АК BELN 2018.12.06 
КонецПроцедуры
