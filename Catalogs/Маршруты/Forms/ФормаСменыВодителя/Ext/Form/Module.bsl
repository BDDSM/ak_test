...
Функция ПолучитьСтруктурноеПодразделениеМаршрута(ТекМаршрут)
	
	Возврат ТекМаршрут.СтруктурноеПодразделение;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого ТекМаршрут Из мМассивМаршрутов Цикл
		...
		НоваяСтрока.СтруктурноеПодразделение 	= ТекМаршрут.СтруктурноеПодразделение;
...
Процедура ТаблицаМаршрутовПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	ТекДанные.СтруктурноеПодразделение 	= ПолучитьСтруктурноеПодразделениеМаршрута(ТекДанные.Маршрут);
