...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//+++AK BATG 2018.12.09
	APDEX_ОценкаПроизводительностиКлиентСервер.НачатьЗамерВремени("Открытие формы Справочник.Номенклатура.ФормаЭлементаУпр");
	//---AK BATG
...
Процедура ПриОткрытии(Отказ)
	...
	//+++AK BATG 2018.12.09
	APDEX_ОценкаПроизводительностиКлиентСервер.ЗакончитьЗамерВремени("Открытие формы Справочник.Номенклатура.ФормаЭлементаУпр", Объект.Наименование);
	//---AK BATG
КонецПроцедуры
...
//+++АК MOSD 2018.12.03 ИП-00019907 
&НаКлиенте
Процедура КомандаВключитьИспользованиеНовойФормы(Команда)
	
	//ВключитьИспользованиеНовойФормыСервер();
	//Предупреждение("Использование новой формы включено.
	//			   |Закройте форму и откройте ее снова.");
