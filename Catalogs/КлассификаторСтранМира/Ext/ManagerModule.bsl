...
//          * Ссылка             - СправочникаСсылка.КлассификаторСтранМира - реквизит найденной страны
...
Функция ДанныеСтраныМира(Знач КодСтраны = Неопределено, Знач Наименование = Неопределено) Экспорт
	...
	НормализованыйКод = КодКлассификаторСтранМира(КодСтраны);
...
Функция ДанныеКлассификатораСтранМираПоКоду(Знач КодСтраны) Экспорт
	...
	ДанныеКлассификатора = ТаблицаКлассификатора();
	СтрокаДанных = ДанныеКлассификатора.Найти(КодКлассификаторСтранМира(КодСтраны), "Код");
...
Процедура ОбновитьСтраныМираПоКлассификатору(Знач Добавлять = Ложь) Экспорт
	...
	Для Каждого СтрокаКлассификатора Из ТаблицаКлассификатора() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации("Обновление информационной базы", 
...
//          * Код - Строка - для поиска страны в классфикаторе
//    Данные - Структура - для заполнения одноименных оставшихся полей создаваемого объекта.
//
// Возвращаемое значение:
//     СправочникСсылка.КлассификаторСтранМира - ссылка на созданый элемент
//
...
//
Функция КодКлассификаторСтранМира(Знач КодСтраны)
