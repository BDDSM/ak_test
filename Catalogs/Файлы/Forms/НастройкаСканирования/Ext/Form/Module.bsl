...
Процедура ОбновитьСостояние()
	...
	Иначе
		...
		Элементы.ВерсияКомпонентыСканирования.Ширина = 12;
		Элементы.ИмяУстройства.Доступность = Ложь;
	КонецЕсли;
КонецПроцедуры
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КачествоJPG =  ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("НастройкиСканирования/КачествоJPG", ИдентификаторКлиента);
	...
	ВидимостьФорматаСканирования = Ложь;
