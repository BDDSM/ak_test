...
Процедура НастройкиПользователя(Команда)
	...
	ФормаРедактированияНастроек = ПолучитьФорму("РегистрСведений.НастройкиПользователей.Форма.ФормаРедактированияНастроек");
	ФормаРедактированияНастроек.НачальноеЗначениеВыбора = ТекущиеДанные.Ссылка;
