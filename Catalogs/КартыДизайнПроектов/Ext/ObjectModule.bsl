...
Процедура ПередЗаписью(Отказ)
	...
	ИсторияИзмененияРеквизитов = РегистрыСведений.ИсторияИзмененияРеквизитовЛКПоставщика.ЗаполнитьДанныеДляИстории(ЭтотОбъект, "ОсобенностиПродукта,СоставПродуктаДляЭтикетки");
	//---АК SHEP 2018.10.22
