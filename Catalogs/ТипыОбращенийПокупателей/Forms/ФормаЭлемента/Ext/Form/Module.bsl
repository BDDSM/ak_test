...
//если технолога уведомляют с горячей линии, с большой вероятностью надо уведомлять при расылке его и поставщика
&НаКлиенте
Процедура УведомлятьТехнологаПриИзменении(Элемент)
	Объект.УведомлятьТехнологаПриРассылке=?(Объект.УведомлятьТехнолога,Истина,Объект.УведомлятьТехнологаПриРассылке);
	Объект.УведомлятьПоставщикаПриРассылке=?(Объект.УведомлятьТехнолога,Истина,Объект.УведомлятьПоставщикаПриРассылке);
КонецПроцедуры
