...
//				ОбщегоНазначенияЗК.КомментарийРасчета("Документ №" + Документ.Номер + " от " + Документ.Дата + " обработан успешно. ", Заголовок, "Открыть", Значение);
...
//						ОтменитьТранзакцию();
//					КонецЕсли;
//					ОбщегоНазначенияЗК.КомментарийРасчета("Документ №" + Документ.Номер + " от " + Документ.Дата + " удалить не удалось! Процедура отмены исправлений отменена. ", , "Открыть", Значение,Перечисления.ВидыСообщений.Ошибка);
...
//	
//	Если ЭтаФорма.ДанныеПрошлойВерсии Тогда
//		Возврат
//	КонецЕсли;
//	
//	ОбновитьТекущегоСотрудникаДляКадровыхИсправлений(ЭтаФорма, СотрудникиИсправление, ТекущийСотрудник);
