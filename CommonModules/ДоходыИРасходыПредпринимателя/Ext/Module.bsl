...
Функция МожноПризнатьРасходыИДоходы(ПризнаватьДоходыИРасходыПоОперациямПрошлогоГода, ДокументОперации, ДатаОперации, Партия = Неопределено) Экспорт
...
Функция ХарактерДеятельностиПоОперации(СтруктураШапкиДокумента, СчетУчета, СтатьяЗатрат, СчетДоходов, УчетнаяПолитика) Экспорт
	...
	Если СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.Товары) ИЛИ СчетУчета = ПланыСчетов.Финансовый.Товары ИЛИ
		 СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ПокупныеТоварыОтгруженные) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ПокупныеТоварыОтгруженные Тогда
	...
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ГотоваяПродукция) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ГотоваяПродукция 
		ИЛИ СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.Полуфабрикаты) ИЛИ СчетУчета = ПланыСчетов.Финансовый.Полуфабрикаты 
		ИЛИ СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ГотоваяПродукцияОтгруженная) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ГотоваяПродукцияОтгруженная Тогда
	...
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.СебестоимостьПродаж) ИЛИ СчетУчета = ПланыСчетов.Финансовый.СебестоимостьПродаж Тогда
	...
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ИздержкиОбращения) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ИздержкиОбращения Тогда
	...
	ИначеЕсли   СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОсновноеПроизводство_) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОсновноеПроизводство_ ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ВспомогательныеПроизводства) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ВспомогательныеПроизводства ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОбслуживающиеПроизводства) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОбслуживающиеПроизводства ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОбщепроизводственныеРасходы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОбщепроизводственныеРасходы ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.БракВПроизводстве) ИЛИ СчетУчета = ПланыСчетов.Финансовый.БракВПроизводстве ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.РасходыНаПродажу) ИЛИ СчетУчета = ПланыСчетов.Финансовый.РасходыНаПродажу Тогда
	...
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ПрочиеДоходыИРасходы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ПрочиеДоходыИРасходы
		ИЛИ СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОбщехозяйственныеРасходы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОбщехозяйственныеРасходы Тогда
	...
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.РасходыБудущихПериодов) ИЛИ СчетУчета = ПланыСчетов.Финансовый.РасходыБудущихПериодов Тогда
		Если СтатьяЗатрат <> Неопределено Тогда		
...
Функция ВидМПЗПоСчетуУчета(СчетУчета, СтатьяЗатрат = Неопределено) Экспорт
	...
	ИначеЕсли СчетУчета = ПланыСчетов.Финансовый.ПустаяСсылка() Тогда
		Возврат Неопределено;
		
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.НематериальныеАктивы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.НематериальныеАктивы Тогда
		Возврат Перечисления.ВидыМПЗ.НМА;	
		
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОсновныеСредства) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОсновныеСредства ИЛИ
			  СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ДоходныеВложенияВ_МЦ) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ДоходныеВложенияВ_МЦ Тогда
		Возврат Перечисления.ВидыМПЗ.ОС;
		
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ПриобретениеОбъектовОсновныхСредств) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ПриобретениеОбъектовОсновныхСредств ИЛИ
			  СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ПриобретениеНематериальныхАктивов) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ПриобретениеНематериальныхАктивов Тогда
		Возврат Перечисления.ВидыМПЗ.КапитальныеВложения;
		
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.Товары) ИЛИ СчетУчета = ПланыСчетов.Финансовый.Товары ИЛИ
		 СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ПокупныеТоварыОтгруженные) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ПокупныеТоварыОтгруженные Тогда
		Возврат Перечисления.ВидыМПЗ.Товары;
		 
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.Материалы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.Материалы Тогда
		Если СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.СырьеИМатериалы)
			ИЛИ СчетУчета = ПланыСчетов.Финансовый.СырьеИМатериалы
			ИЛИ СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.МатериалыПереданныеВПереработку)
			ИЛИ СчетУчета = ПланыСчетов.Финансовый.МатериалыПереданныеВПереработку Тогда
	...
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ГотоваяПродукция) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ГотоваяПродукция ИЛИ
		 	  СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ГотоваяПродукцияОтгруженная) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ГотоваяПродукцияОтгруженная Тогда
			  
		Возврат Перечисления.ВидыМПЗ.Продукция;	
		
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ПроизводствоИзДавальческогоСырья) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ПроизводствоИзДавальческогоСырья Тогда
		// Продукция из давальческого сырья не отражается в НУ ИП
		Возврат Неопределено;	
		
	ИначеЕсли   СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОсновноеПроизводство) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОсновноеПроизводство ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ВспомогательныеПроизводства) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ВспомогательныеПроизводства ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОбслуживающиеПроизводства) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОбслуживающиеПроизводства ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОбщепроизводственныеРасходы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОбщепроизводственныеРасходы ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ОбщехозяйственныеРасходы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ОбщехозяйственныеРасходы ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.БракВПроизводстве) ИЛИ СчетУчета = ПланыСчетов.Финансовый.БракВПроизводстве ИЛИ
				СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.РасходыНаПродажу) ИЛИ СчетУчета = ПланыСчетов.Финансовый.РасходыНаПродажу Тогда
	...
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ПрочиеДоходыИРасходы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ПрочиеДоходыИРасходы Тогда
		Если СтатьяЗатрат <> Неопределено Тогда
	...
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.Полуфабрикаты) ИЛИ СчетУчета = ПланыСчетов.Финансовый.Полуфабрикаты Тогда
		Возврат Перечисления.ВидыМПЗ.Полуфабрикаты;
		
	ИначеЕсли СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.НедостачиИПотериОтПорчиЦенностей) ИЛИ СчетУчета = ПланыСчетов.Финансовый.НедостачиИПотериОтПорчиЦенностей Тогда
		Возврат Перечисления.ВидыМПЗ.ИныеМатериальныеРасходы;
		
	ИначеЕсли (СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ДенежныеДокументы) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ДенежныеДокументы) 
		ИЛИ (СчетУчета.ПринадлежитЭлементу(ПланыСчетов.Финансовый.ДенежныеДокументыВал) ИЛИ СчетУчета = ПланыСчетов.Финансовый.ДенежныеДокументыВал) Тогда
		Возврат Перечисления.ВидыМПЗ.ПрочиеРасходы;
...
Процедура ПодборПартииВозвратаТары(ДокументОбъект, СтруктураШапкиДокумента, СписокМПЗ)
	...
	ПараметрыОтбора = Новый Структура;
	ПараметрыОтбора.Вставить("СчетУчета", ПланыСчетов.Финансовый.Тара);
...
Процедура ЗачетОплатыОтПокупателяДвижения(ДокументОбъект, СтруктураШапкиДокумента, СписокМПЗ, СписокПлатежей)
	...
	ПризнаватьДоходыИРасходыПоОперациямПрошлогоГода = СтруктураШапкиДокумента.ПризнаватьДоходыИРасходыПоОперациямПрошлогоГода;
		...
		Для Каждого ДокументОплаты Из СписокПлатежей Цикл
			...
			МожноПризнатьДоход = МожноПризнатьРасходыИДоходы(ПризнаватьДоходыИРасходыПоОперациямПрошлогоГода, ДокументОплаты.ДокументОплаты, СтруктураШапкиДокумента.Дата);
...
Процедура ДобавитьДвижениеПоОплате(ДокументОбъект, СтруктураШапкиДокумента, СтатьяРасчетов, Приход, Сторно, Товар, Количество, Сумма, НДС, Выручка, НДСНачисленный, РеквизитыДокументаОплаты)
	...
	ИначеЕсли СтатьяРасчетов = 4 Тогда
		...
		МожноПризнатьРасход = МожноПризнатьРасходыИДоходы(ПризнаватьДоходыИРасходыПоОперациямПрошлогоГода, Товар.ДокументОтгрузки, СтруктураШапкиДокумента.Дата, Товар.Партия);
				...
				Пока Товар.Следующий() Цикл
					...
					Если (СуммаОплаты <> 0) И ((Товар.СуммаРасход + Товар.НДСРасход) <> 0) Тогда // оплата списанного товара
						...
						Иначе
							...
							оличество = Окр(Товар.КоличествоРасход * СуммаОплаты / (Товар.СуммаРасход + Товар.НДСРасход), 3, 1);
							НДС = СуммаОплаты - СуммаБезНДС;
						КонецЕсли;
...
Процедура ОтражениеРасходовНаОплатуТруда(ДокументОбъект, ВыборкаПоДоходам, УчетнаяПолитика, Режим) Экспорт
	...
	Пока ВыборкаПоДоходам.Следующий() Цикл
		Если ВыборкаПоДоходам.СчетКт = ПланыСчетов.Финансовый.РасчетыСПерсоналомПоОплатеТруда Тогда
		...
		ИначеЕсли ВыборкаПоДоходам.СчетКт.ПринадлежитЭлементу(ПланыСчетов.Финансовый.РасчетыПоСоциальномуСтрахованию) Тогда
		...
		ИначеЕсли ВыборкаПоДоходам.СчетДт = ПланыСчетов.Финансовый.РасчетыСПерсоналомПоОплатеТруда Тогда
			
			Если ВыборкаПоДоходам.СчетКт = ПланыСчетов.Финансовый.НДФЛ Тогда
				НовСтр = ТабУдержания.Добавить();
				НовСтр.СчетУчета = ПланыСчетов.Финансовый.НДФЛ;
	...
	СчетаУчета.Добавить(ПланыСчетов.Финансовый.ПустаяСсылка());
	...
	Пока НомСтроки < ТаблицаПлатежей.Количество() Цикл
		...
		ИначеЕсли (ТаблицаПлатежей[НомСтроки].Сумма < 0) И (ТаблицаПлатежей[НомСтроки].СчетУчета = ПланыСчетов.Финансовый.НДФЛ) Тогда
			ТаблицаПлатежей.Удалить(НомСтроки);
		Иначе
			НомСтроки = НомСтроки + 1;
		КонецЕсли;
...
Процедура ПеречислениеНалога(ДокументОбъект, СтруктураШапкиДокумента, ТаблицаАвансов) Экспорт
	...
	Если СтруктураШапкиДокумента.СчетУчетаРасчетовСКонтрагентом = ПланыСчетов.Финансовый.НДФЛ Тогда
