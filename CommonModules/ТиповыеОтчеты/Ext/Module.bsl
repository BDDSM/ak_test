...
#Если Клиент Тогда
	...
	Процедура ОбновитьФормуТиповогоОтчетаПоКомпоновщику(ОтчетОбъект, ФормаОтчета) Экспорт
		...
		Если ЭтоСтараяВерсияОтчета(ОтчетОбъект) Тогда
			...
			ЕстьПанельПериод = ФормаОтчета.ЭлементыФормы.Найти("ПанельПериод") <> Неопределено;
			ЕстьПанельДействияФормы = ФормаОтчета.ЭлементыФормы.Найти("ДействияФормы") <> Неопределено;
			...
			Если ЕстьПанельДействияФормы Тогда
