...
Функция ЗаданиеВыполнено(Знач ИдентификаторЗадания) Экспорт
	...
	Если ПоказатьПолныйТекстОшибки Тогда
		//LATV: в конфигурации было ПолучитьИнформациюОбОшибке. Не знаю это БСП или локальные доработки, поэтому оставил
...
Функция СообщенияПользователю(УдалятьПолученные = Ложь, ИдентификаторЗадания = Неопределено) Экспорт
	...
	Для Каждого Сообщение Из ВсеСообщения Цикл
		Если Найти(Сообщение.Текст, "{" + СообщениеПрогресса() + "}") = 1 Тогда
...
Процедура УстановкаПараметровСеанса(ИмяПараметра, УстановленныеПараметры) Экспорт
	...
	Если ИмяПараметра = "ОтмененныеДлительныеОперации" Тогда
		...
		УстановленныеПараметры.Вставить("ОтмененныеДлительныеОперации");
	КонецЕсли;
