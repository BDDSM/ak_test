...
Процедура НачатьЗамерПередЗаписью(Источник, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	...
	Если (РежимЗаписи = РежимЗаписиДокумента.Проведение) Тогда
		...
		Операция = APDEX_ОценкаПроизводительностиСерверВызовСервера.ПолучитьОперацию(""+Источник.Метаданные() + " (проведение)");
...
Функция ПолучитьОперацию(ИмяОперации) Экспорт
	
	Возврат APDEX_ОценкаПроизводительностиСерверВызовСервера.ПолучитьОперацию(ИмяОперации);
