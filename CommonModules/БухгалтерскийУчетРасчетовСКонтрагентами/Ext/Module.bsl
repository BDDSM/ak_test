...
Процедура ПодготовкаТаблицыЗначенийДляЦелейПриобретенияИРеализации(ТаблицаЗначений, СтруктураШапкиДокумента, ВключитьНДСВОсновнуюСумму, ВалютаРегламентированногоУчета = "") Экспорт
	...
	Если ЕстьВалюта и ЕстьНДС и ЕстьСтавкаНДС
	...
	Если СтруктураШапкиДокумента.ОрганизацияПрименяетУСН 
		...
		Если НетКолонкиДоходКомитента Тогда
			...
			Если ЕстьСчетУчетаВТаблице Тогда
				...
				Выборка = ПланыСчетов.Финансовый.Выбрать(ПланыСчетов.Финансовый.ТоварыПринятыеНаКомиссию);
...
Функция ОпределениеНаправленияДвиженияДляДокументаПриобретенияРеализации(ВидДокумента, ВидОперации = Неопределено) Экспорт
	...
	Если ВидДокумента = "НачислениеАренднойПлаты"
		ИЛИ ВидДокумента = "НачислениеПени" тогда 
		Если ВидОперации= "КомиссионнаяВыручка" тогда
			ВидыДокументов.Вставить("НачислениеАренднойПлаты", "Поступление");
			ВидыДокументов.Вставить("НачислениеПени",          "Поступление");
		Иначе
			ВидыДокументов.Вставить("НачислениеАренднойПлаты", "Выбытие");
			ВидыДокументов.Вставить("НачислениеПени",          "Выбытие");
		КонецЕсли;
	КонецЕсли;  
	...
	Иначе
		...
		Если    (ВидДокумента = "РеализацияУслугПоПереработке")
			...
			или (ВидДокумента = "НачислениеАренднойПлаты") 
			или (ВидДокумента = "НачислениеПени") 
...
Функция ОпределениеНаправленияДвиженияДляДокументаДвиженияДенежныхСредств(Знач ВидДокумента,ВидОперации = неопределено) Экспорт
	...
	ВидыДокументовДДС.Вставить("РасходИзБанка", "Выбытие");
	ВидыДокументовДДС.Вставить("РасходИзКассы", "Выбытие");
	ВидыДокументовДДС.Вставить("ПоступлениеВБанк", "Поступление");
	ВидыДокументовДДС.Вставить("ПоступлениеВКассу", "Поступление");
	...
	Если ЗначениеЗаполнено(ВидОперации) тогда
		...
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийРКО.ОплатаПостояннойЧастиАрендыАрендодателю,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийРКО.ОплатаПеременнойЧастиАрендыАрендодателю,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийРКО.ОплатаДепозитаАрендодателю,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийРКО.ВозвратПостояннойЧастиАрендыАрендатору,ВидОперацииВозврат);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийРКО.ВозвратПеременнойЧастиАрендыАрендатору,ВидОперацииВозврат);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийРКО.ВозвратДепозитаАрендатору,ВидОперацииВозврат);

		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПКО.ОплатаПостояннойЧастиАрендыОтАрендатора,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПКО.ОплатаПеременнойЧастиАрендыОтАрендатора,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПКО.ОплатаДепозитаОтАрендатора,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПКО.ВозвратПостояннойЧастиАрендыОтАрендодателя,ВидОперацииВозврат);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПКО.ВозвратПеременнойЧастиАрендыОтАрендодателя,ВидОперацииВозврат);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПКО.ВозвратДепозитаОтАрендодателя,ВидОперацииВозврат);

		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийППИсходящее.ОплатаПоставщику,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийППИсходящее.ОплатаПостояннойЧастиАрендыАрендодателю,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийППИсходящее.ОплатаПеременнойЧастиАрендыАрендодателю,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийППИсходящее.ОплатаДепозитаАрендодателю,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийППИсходящее.ВозвратПостояннойЧастиАрендыАрендатору,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийППИсходящее.ВозвратПеременнойЧастиАрендыАрендатору,ВидОперацииВозврат);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийППИсходящее.ВозвратДепозитаАрендатору,ВидОперацииВозврат);

		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПоступлениеБезналичныхДенежныхСредств.ОплатаПостояннойЧастиАрендыОтАрендатора,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПоступлениеБезналичныхДенежныхСредств.ОплатаПеременнойЧастиАрендыОтАрендатора,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПоступлениеБезналичныхДенежныхСредств.ОплатаДепозитаОтАрендатора,ВидОперацииРасчет);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПоступлениеБезналичныхДенежныхСредств.ВозвратПостояннойЧастиАрендыОтАрендодателя,ВидОперацииВозврат);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПоступлениеБезналичныхДенежныхСредств.ВозвратПеременнойЧастиАрендыОтАрендодателя,ВидОперацииВозврат);
		РасчетВозвратПоВидуОпераций.Вставить(Перечисления.ВидыОперацийПоступлениеБезналичныхДенежныхСредств.ВозвратДепозитаОтАрендодателя,ВидОперацииВозврат);
...
//+++АК SaMi 
Функция ПолучитьСчетаДляУчетаНаРегистреРасчетовСКонтрагентами() Экспорт
	
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами = Новый Массив;
	
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Добавить(ПланыСчетов.Финансовый.РасчетыСПоставщиками);
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Добавить(ПланыСчетов.Финансовый.ПрочаяЗадолженность);
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Добавить(ПланыСчетов.Финансовый.РасчетыСПоставщикамиУпаковки);
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Добавить(ПланыСчетов.Финансовый.РасчетыСПоставщикамиОборудования);
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Добавить(ПланыСчетов.Финансовый.РасчетыСПрочимиПоставщикамиИПодрядчиками);
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Добавить(ПланыСчетов.Финансовый.РасчетыСПрочимиПоставщикамиИПодрядчикамиФакторинг);	
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Добавить(ПланыСчетов.Финансовый.РасчетыСПокупателямиПрочие);

	Возврат СчетаДляУчетаНаРегистреРасчетовСКонтрагентами;
	
КонецФункции

Процедура СформироватьДвиженияПоРасчетамСКонтрагентами(ДокОбъект) Экспорт
	
	Если ДокОбъект.Дата<Дата(2017,1,1) Тогда
		Возврат;
	КонецЕсли; 
	...
	СчетаДляУчетаНаРегистреРасчетовСКонтрагентами = ПолучитьСчетаДляУчетаНаРегистреРасчетовСКонтрагентами();
	
	ТаблицаДвижений = ДокОбъект.Движения.РасчетыСКонтрагентами.ВыгрузитьКолонки();
	
	Заявка = Неопределено;
	
	Если ТипЗнч(ДокОбъект) = Тип("ДокументОбъект.КорректировкаВзаиморасчетов") Тогда		
		ПервичныйДокумент = ДокОбъект.ДокументОснование;
	//+++susk
	//ИП-00016528	
	ИначеЕсли ТипЗнч(ДокОБъект) = Тип("ДокументОбъект.КорректировкаПоступления") Тогда
		ПервичныйДокумент = ДокОбъект.ИсправляемыйДокументПоступления;
	//---susk
	Иначе		
		ПервичныйДокумент = ДокОбъект;
	КонецЕсли;
		
	Если ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.РасходИзБанка") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументСсылка.РасходИзБанка") Тогда
		Заявка = ПервичныйДокумент.ЗаявкаНаРасходованиеСредств;
	ИначеЕсли ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.РасходИзКассы") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументСсылка.РасходИзКассы") Тогда
		Заявка = ПервичныйДокумент.ЗаявкаНаРасходованиеСредств;
	ИначеЕсли ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ПоступлениеДопРасходов") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументСсылка.ПоступлениеДопРасходов") Тогда
		Заявка = ПервичныйДокумент.ЗаявкаНаРсходованиеСредств;
	ИначеЕсли ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ПоступлениеТоваровУслуг") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументСсылка.ПоступлениеТоваровУслуг") Тогда
		//+++AK GREK 03.11.2017 ИП-00017009
		//Заявка = ПервичныйДокумент.Заявка;
		Если ЗначениеЗаполнено(ПервичныйДокумент.Заявка) Тогда
 			Заявка = ПервичныйДокумент.Заявка;
		ИначеЕсли ЗначениеЗаполнено(ПервичныйДокумент.ДокументОснование) Тогда
			Заявка = ПервичныйДокумент.ДокументОснование;
		КонецЕсли;
		//---AK
	ИначеЕсли ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.МаршрутныйЛист") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументСсылка.МаршрутныйЛист") Тогда
		Заявка = ПервичныйДокумент.Заявка;
	ИначеЕсли ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ОбщиеТранспортныеРасходы") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументСсылка.ОбщиеТранспортныеРасходы") Тогда
		Заявка = ПервичныйДокумент.Заявка;
	ИначеЕсли ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ДоставкаНаТТ") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументСсылка.ДоставкаНаТТ") Тогда
		Заявка = ПервичныйДокумент.Заявка;
	КонецЕсли; 
	
	
	Для Каждого Проводка ИЗ ДокОбъект.Движения.Финансовый Цикл
		
			Если СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Найти(Проводка.СчетДт) <> Неопределено Тогда
				Движение = ТаблицаДвижений.Добавить();
				Движение.ВидДвижения	= ВидДвиженияНакопления.Приход;
				Движение.Регистратор	= Проводка.Регистратор;
				Движение.Период			= Проводка.Период;
				Движение.Организация = Проводка.СубконтоДт.Организации;
				Движение.Контрагент = Проводка.СубконтоДт.Контрагенты;
				//+++AK GREK 03.11.2017 ИП-00017009
				Если ЗначениеЗаполнено(Заявка) И (ТипЗнч(Заявка) = Тип("ДокументСсылка.ЗаявкаНаУслугиМатериалы") ИЛИ ТипЗнч(Заявка) = Тип("ДокументСсылка.ЗаявкаНаРасходованиеСредств"))Тогда
		 			Движение.Сделка = Заявка.Ссылка;
				КонецЕсли; 
				//---AK
				//+++АК LAGP 2018.05.10 ИП-00018465 Для подстановки в РТУ Тилси-Перекресток
				Если (ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.РеализацияТоваровУслуг") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ВозвратТоваровОтПокупателя") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ПоступлениеВБанк")) И ЗначениеЗаполнено(ПервичныйДокумент.ДоговорКонтрагента) Тогда //+++АК LAGP 2018.06.26 ИП-00018465.04 Добавлены в условие документы ВозвратОтПокупателя и ПоступлениеВБанк
					Если ПервичныйДокумент.Организация = Справочники.Организации.НайтиПоКоду("000000009") Тогда //+++АК LAGP 2018.06.26 ИП-00018465.04 Добавлено условие по организации ТИЛСИ
						Движение.Сделка = ПервичныйДокумент.Ссылка;
					КонецЕсли;	
				КонецЕсли;	
				//---АК LAGP
				Если Проводка.СчетДт= ПланыСчетов.Финансовый.РасчетыСПоставщикамиОборудования Тогда
					Движение.СчетУчета = ПланыСчетов.Финансовый.ПрочаяЗадолженность;
				Иначе
					Движение.СчетУчета = Проводка.СчетДт;
				КонецЕсли; 
			...
			Если СчетаДляУчетаНаРегистреРасчетовСКонтрагентами.Найти(Проводка.СчетКт) <> Неопределено Тогда
				...
				//+++АК LAGP 2018.06.26 ИП-00018465.04  Добавлены в условие документы ВозвратОтПокупателя и ПоступлениеВБанк, организация ТИЛСИ
				ИначеЕсли (ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.РеализацияТоваровУслуг") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ВозвратТоваровОтПокупателя") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ПоступлениеВБанк")) И ЗначениеЗаполнено(ПервичныйДокумент.ДоговорКонтрагента) Тогда //+++АК LAGP 2018.06.26 ИП-00018465.04 Добавлены в условие документы ВозвратОтПокупателя и ПоступлениеВБанк
					Если ПервичныйДокумент.Организация = Справочники.Организации.НайтиПоКоду("000000009") Тогда //+++АК LAGP 2018.06.26 ИП-00018465.04 Добавлено условие по организации ТИЛСИ
						Движение.Сделка = ПервичныйДокумент.Ссылка;
					КонецЕсли;							
				//---АК LAGP	
				...
				КонецЕсли; 
				//---AK
				Если Проводка.СчетКт= ПланыСчетов.Финансовый.РасчетыСПоставщикамиОборудования Тогда
					Движение.СчетУчета = ПланыСчетов.Финансовый.ПрочаяЗадолженность;
				Иначе
				...
				//+++АК LAGP 2018.05.11 ИП-00018465 Проводки по измерению "Сделка", для РТУ Тилси-Перекресток 
				//+++АК LAGP 2018.06.26 ИП-00018465.04 Закомментированно т.к. движения будет делать новый документ "Распределение платежа по РТУ и возвратам"
				//Если ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ПоступлениеВБанк") И ПервичныйДокумент.СопоставлениеРТУ.Количество() > 0 И НЕ ПервичныйДокумент.СопоставлениеРТУ.Итог("СуммаВносимая") > ПервичныйДокумент.СуммаДокумента Тогда
				//	ТаблицаДвижений.Очистить();
				//	Для каждого СтрокаРТУ Из ПервичныйДокумент.СопоставлениеРТУ Цикл
				//		Движение = ТаблицаДвижений.Добавить();
				//		Движение.ВидДвижения	= ВидДвиженияНакопления.Расход;
				//		Движение.Регистратор	= Проводка.Регистратор;
				//		Движение.Период			= Проводка.Период;
				//		Движение.Организация 	= Проводка.СубконтоКт.Организации;
				//		Движение.Контрагент 	= Проводка.СубконтоКт.Контрагенты;
				//		Движение.Сделка 		= СтрокаРТУ.РеализацияТоваровИУслуг;
				//		Если Проводка.СчетКт	= ПланыСчетов.Финансовый.РасчетыСПоставщикамиОборудования Тогда
				//			Движение.СчетУчета 	= ПланыСчетов.Финансовый.ПрочаяЗадолженность;
				//		Иначе
				//			Движение.СчетУчета 	= Проводка.СчетКт;
				//		КонецЕсли; 
				//		
				//		Движение.Сумма			= СтрокаРТУ.СуммаВносимая;	
				//	КонецЦикла;	
				//	
				//	Если ПервичныйДокумент.СопоставлениеРТУ.Итог("СуммаВносимая") < ПервичныйДокумент.СуммаДокумента Тогда
				//		Движение = ТаблицаДвижений.Добавить();
				//		Движение.ВидДвижения	= ВидДвиженияНакопления.Расход;
				//		Движение.Регистратор	= Проводка.Регистратор;
				//		Движение.Период			= Проводка.Период;
				...
				//		КонецЕсли; 
				//		
				//		Движение.Сумма			= ПервичныйДокумент.СуммаДокумента - ПервичныйДокумент.СопоставлениеРТУ.Итог("СуммаВносимая");
				//	КонецЕсли;	
				//КонецЕсли;
				//---АК LAGP
			КонецЕсли; 
	...
	ТаблицаДвижений.Свернуть("ВидДвижения, Регистратор, Период, Организация, Контрагент, Сделка, СчетУчета", "Сумма");
	
	//+++АК pozm ИП-00016295 24.08.2017
	Если ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.ПоступлениеДопРасходов") ИЛИ ТипЗнч(ПервичныйДокумент) = Тип("ДокументСсылка.ПоступлениеДопРасходов") Тогда
		Для Каждого СтрокаДоп Из ПервичныйДокумент.НоменклатураДопОборудование Цикл
			Если Не (ЗначениеЗаполнено(СтрокаДоп.Сделка) И ТипЗнч(СтрокаДоп.Сделка) = Тип("ДокументСсылка.СделкаСПоставщиком")) Тогда
				Продолжить;
			КонецЕсли;	
			СуммаКРаспределению = СтрокаДоп.Сумма;
			СтрокиРасходаКРаспределению = ТаблицаДвижений.НайтиСтроки(Новый Структура("ВидДвижения,Сделка",ВидДвиженияНакопления.Расход,Неопределено));
			Для Каждого СтрокаРасхода Из СтрокиРасходаКРаспределению Цикл
				СуммаДвижения = Мин(СуммаКРаспределению,СтрокаРасхода.Сумма);
				СуммаКРаспределению = СуммаКРаспределению-СуммаДвижения;
				Движение = ТаблицаДвижений.Добавить(); // сторнируем по пустой
				Движение.Сумма = -СуммаДвижения;
				ЗаполнитьЗначенияСвойств(Движение,СтрокаРасхода,,"Сумма");
				
				Движение = ТаблицаДвижений.Добавить();// оприходуем по заполненной
				Движение.Сумма = СуммаДвижения;
				ЗаполнитьЗначенияСвойств(Движение,СтрокаРасхода,,"Сумма");
				Движение.Сделка = СтрокаДоп.Сделка;
				Если СуммаКРаспределению = 0 Тогда
					Прервать;
				КонецЕсли;	
			КонецЦикла;	
	...
	НулевыеСуммы = ТаблицаДвижений.НайтиСтроки(Новый Структура("Сумма",0));
	Для Каждого СтрокаКУдалению Из НулевыеСуммы Цикл
		ТаблицаДвижений.Удалить(СтрокаКУдалению);
	КонецЦикла;	
	//---АК pozm ИП-00016295
	
	//+++АК LAGP 2018.06.26 ИП-00018465.04 Создание объекта.
	Если ТипЗнч(ПервичныйДокумент) = Тип("ДокументОбъект.РаспределениеПлатежей") Тогда
		ТаблицаРаспределяемыхДокументов = ПервичныйДокумент.ТаблицаРаспределяемыхДокументов;
		//Сделки из табличной части
		СуммаРаспределяемаяСПлатежногоДокумента = 0;
		Если ЗначениеЗаполнено(ПервичныйДокумент.ПлатежныйДокумент) Тогда
			ДатаРегистрацииЗаписей = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ПервичныйДокумент.ПлатежныйДокумент, "Дата");
		Иначе 	
			ДатаРегистрацииЗаписей = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ПервичныйДокумент, "Дата");
		КонецЕсли;	
			
		Для Каждого ТекСтрокаТаблицаРаспределяемыхДокументов Из ТаблицаРаспределяемыхДокументов Цикл 
			Движение = ТаблицаДвижений.Добавить();
			Движение.ВидДвижения = ?(ТипЗнч(ТекСтрокаТаблицаРаспределяемыхДокументов.Сделка) = Тип("ДокументСсылка.РеализацияТоваровУслуг"), ВидДвиженияНакопления.Расход, ВидДвиженияНакопления.Приход); 
			Движение.Период = ДатаРегистрацииЗаписей;
			Движение.Организация = ПервичныйДокумент.Организация;
			Движение.Контрагент = ПервичныйДокумент.Контрагент;
			Движение.СчетУчета = ОбщегоНазначенияПовтИсп.ВернутьСчетПоУсловию("62.1", "Финансовый");
			Движение.Сделка = ТекСтрокаТаблицаРаспределяемыхДокументов.Сделка;
			Движение.Сумма = ТекСтрокаТаблицаРаспределяемыхДокументов.СуммаРаспределяемая;
			
			Если Движение.ВидДвижения = ВидДвиженияНакопления.Расход Тогда
				СуммаРаспределяемаяСПлатежногоДокумента = СуммаРаспределяемаяСПлатежногоДокумента + ТекСтрокаТаблицаРаспределяемыхДокументов.СуммаРаспределяемая;	
			Иначе
				СуммаРаспределяемаяСПлатежногоДокумента = СуммаРаспределяемаяСПлатежногоДокумента - ТекСтрокаТаблицаРаспределяемыхДокументов.СуммаРаспределяемая;
			КонецЕсли;				
		КонецЦикла;	
		
		//Платёжный документ за счёт которого списываются суммы сделок 
		Если ЗначениеЗаполнено(ПервичныйДокумент.ПлатежныйДокумент) Тогда //предусмотрено проведение без платёжного документа, для выравнивания сумм реализаций в закрытом периоде
			Движение = ТаблицаДвижений.Добавить();
			Движение.ВидДвижения = ВидДвиженияНакопления.Приход; 
			Движение.Период = ДатаРегистрацииЗаписей;
			Движение.Организация = ПервичныйДокумент.Организация;
			Движение.Контрагент = ПервичныйДокумент.Контрагент;
			Движение.СчетУчета = ОбщегоНазначенияПовтИсп.ВернутьСчетПоУсловию("62.1", "Финансовый");
			Движение.Сделка = ПервичныйДокумент.ПлатежныйДокумент;		
			Движение.Сумма = СуммаРаспределяемаяСПлатежногоДокумента;
		КонецЕсли;	
			
	КонецЕсли;
	//---АК LAGP
	
	ДокОбъект.Движения.РасчетыСКонтрагентами.Загрузить(ТаблицаДвижений);
