...
Процедура ЗагрузитьКлассификаторАдресов(КодыСубъектовРФ, ОписаниеФайлов, ОповещатьОПрогрессе = Истина) Экспорт
	...
	ЗаписатьДанные(Набор); // Отключаем всю бизнес-логику для ускорения операции.
...
Процедура ПеренестиРегионИзДанныхКЛАДР(СубъектРФ)
	...
	ЗаписатьДанные(АдресныеОбъекты);
	...
	ЗаписатьДанные(ДомаЗданияСтроения);
	...
	ЗаписатьДанные(ДополнительныеАдресныеСведения);
	...
	ЗаписатьДанные(НаборСлужебныеАдресныеСведения);
