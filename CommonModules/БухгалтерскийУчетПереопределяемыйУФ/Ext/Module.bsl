...
//			Сведения.Вставить("ФИОПБОЮЛ",						ФизическиеЛица.ФамилияИнициалыФизЛица(ДанныеЮрФизЛица.ИндивидуальныйПредприниматель));
//			
...
//			Сведения.Вставить("Факс",				УправлениеКонтактнойИнформацией.ПолучитьКонтактнуюИнформацияОбъекта(
//				ДанныеЮрФизЛица.ИсточникКонтактнойИнформации, ДанныеЮрФизЛица.ВидыКонтактнойИнформацииФакс));
//			
...
Функция ПолучитьЗначениеПоУмолчанию(Настройка, Пользователь = Неопределено) Экспорт
	...
	Если НастройкаВРег = ВРег("ОсновнаяОрганизация") Тогда
		...
		ИмяОбъекта = "Справочник.Организации";
...
//	
//	Возврат(УчетОбособленныхПодразделений.ПолучитьВидыСубконтоРасчетовПоНалогамИСборам());
//	
//КонецФункции
