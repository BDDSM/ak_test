...
Процедура ОпределитьНеобходимостьОбновленияАдресныхОбъектов(Владелец = Неопределено) Экспорт
	...
	//		Владелец, 
	//		Новый ОписаниеОповещения("ПолучениеРазрешенияБезопасностиПроверкиНаличияОбновленияАдресныхОбъектов", ОбщегоНазначенияКлиент.ОбщийМодуль("АдресныйКлассификаторКлиент"))
	//	);
	//	
	//Иначе
...
Процедура ОбработкаНеобходимостиОбновленияАдресныхОбъектов(Знач ДанныеОбновления)
	...
	Оповещение = Новый ОписаниеОповещения("ОпределитьНеобходимостьОбновленияАдресныхОбъектовЗавершение", 
		ОбщегоНазначенияКлиент.ОбщийМодуль("АдресныйКлассификаторКлиент"), АдресныеОбъекты);
		
	ПараметрыВопроса = ОбщегоНазначенияКлиент.ПараметрыВопросаПользователю();
...
#Если ВебКлиент Тогда
	...
	ОбщегоНазначенияКлиент.ПоказатьВопросПользователю(Оповещение, 
...
Процедура ВыбратьКаталог(Знач Форма, Знач ПутьКДанным, Знач Заголовок = Неопределено, СтандартнаяОбработка = Ложь) Экспорт
	...
	Оповещение = Новый ОписаниеОповещения("ВыбратьКаталогЗавершениеКонтроляРасширенияРаботыСФайлами", ОбщегоНазначенияКлиент.ОбщийМодуль("АдресныйКлассификаторКлиент"), Новый Структура);
