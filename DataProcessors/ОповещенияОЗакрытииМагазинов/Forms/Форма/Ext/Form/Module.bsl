...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если Параметры.Свойство("УказыватьДопИнформациюПриЗакрытии") Тогда
        ЭтаФорма.УказыватьДопИнформациюПриЗакрытии = Параметры.УказыватьДопИнформациюПриЗакрытии;
	Иначе
		ЭтаФорма.УказыватьДопИнформациюПриЗакрытии = Ложь;
    КонецЕсли;
...
Процедура Реквизит1ОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	Если УказыватьДопИнформациюПриЗакрытии И ТипЗнч(ВыбранноеЗначение) = Тип("СправочникСсылка.СтруктурныеЕдиницы") Тогда
		СтруктураПараметров = Новый Структура;
		СтруктураПараметров.Вставить("Ключ", ВыбранноеЗначение);
		СтруктураПараметров.Вставить("ТолькоЗакрытиеМагазина", Истина);
		ОткрытьФорму("Справочник.СтруктурныеЕдиницы.Форма.НовыйМагазин", СтруктураПараметров, ЭтаФорма);
	Иначе
