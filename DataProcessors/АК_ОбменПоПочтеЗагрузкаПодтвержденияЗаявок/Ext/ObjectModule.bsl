...
Процедура ОтработатьПодтвержденияСервер() Экспорт
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ИначеЕсли  ВыборкаДетальныеЗаписи.ТипЗаявки = 14 И ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.ЗаявкаНаУслугиМатериалы) Тогда
				Справочники.СтруктурныеЕдиницы.ОбработатьПодтверждениеЗакрытияИзПисьма(ВыборкаДетальныеЗаписи.ЗаявкаНаУслугиМатериалы, 
					Новый Структура("Согласовано, Отклонено", ВыборкаДетальныеЗаписи.Акцептировано1, ВыборкаДетальныеЗаписи.Отклонено1));			
		//---AK
		КонецЕсли;
