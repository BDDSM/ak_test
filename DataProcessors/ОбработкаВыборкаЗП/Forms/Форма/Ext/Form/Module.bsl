...
&НаКлиенте
Процедура ПостроитьТаблицу(Команда)
	
	Состояние("Идет выборка данных. Ожидайте...");
	ПостроитьТаблицуНаСервере();
...
&НаСервере
Процедура ПостроитьТаблицуНаСервере() Экспорт
	...
	ЗаполнитьОтборы(СхемаКомпоновкиДанныхПокупатели.ВариантыНастроек.Получить(0).Настройки.Отбор, Объект.ВыборкаЗП.ХранилищеОтборПокупатели.Получить(), СхемаКомпоновкиДанныхПокупатели.ВариантыНастроек.Покупатели.Настройки.Выбор.Элементы);
	...
	ЗаполнитьОтборы(СхемаКомпоновкиДанныхТОВАРЫ.ВариантыНастроек.Получить(0).Настройки.Отбор, Объект.ВыборкаЗП.ХранилищеОтборТовары.Получить(), СхемаКомпоновкиДанныхТОВАРЫ.ВариантыНастроек.Получить(0).Настройки.Выбор.Элементы);
	//Макет компоновки
	...
	ЗаполнитьОтборы(СхемаКомпоновкиДанныхПроизводитель.ВариантыНастроек.Получить(0).Настройки.Отбор, Объект.ВыборкаЗП.ХранилищеОтборТовары.Получить(), СхемаКомпоновкиДанныхПроизводитель.ВариантыНастроек.Получить(0).Настройки.Выбор.Элементы);
	//Макет компоновки
	...
	// ПОЛУЧАЕМ ЧЕКИ	
	//Получение самой СКД из макета
	Если Объект.Проект = Перечисления.Проекты.Избенка Тогда
	...
	ЗаполнитьОтборы(СхемаКомпоновкиДанныхЧЕКИ.ВариантыНастроек.Получить(0).Настройки.Отбор, Объект.ВыборкаЗП.ХранилищеОтборТовары.Получить(), СхемаКомпоновкиДанныхЧЕКИ.ВариантыНастроек.Получить(0).Настройки.Выбор.Элементы);
