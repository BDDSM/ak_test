...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НетНарушенияПрав = УправлениеДопПравамиПользователей.ПолучитьПравоПользователяУпр(ПланыВидовХарактеристик.ПраваПользователей.НайтиПоНаименованию("Установка квот маршрутов")		, Ложь)
...
Процедура ПриОткрытии(Отказ)
	Если НЕ НетНарушенияПрав Тогда
