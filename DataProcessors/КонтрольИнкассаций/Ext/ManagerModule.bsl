...
Процедура СформироватьИОтправитьПисьмаПревышенияЛимита(НачПериода = Неопределено) Экспорт
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда		
		...
		СтруктураПисьма.Вставить("Тема", "Обработка КонтрольИнкассаций (перед ПолучитьТаблицуАдресов) - " + ТекущаяДата());
		СтруктураПисьма.Вставить("Тело", "123");
		СтруктураПисьма.Вставить("СписокФайловВложений", Новый Массив);
		...
		СтруктураПисьма.Вставить("Тема", "Обработка КонтрольИнкассаций (после ПолучитьТаблицуАдресов) - " + ТекущаяДата());
		СтруктураПисьма.Вставить("Тело", "123");
		СтруктураПисьма.Вставить("СписокФайловВложений", Новый Массив);
	...
	СтруктураПисьма.Вставить("Тема", "Обработка КонтрольИнкассаций (перед ТаблицаДанных.Скопировать) - " + ТекущаяДата());
	СтруктураПисьма.Вставить("Тело", "123");
	СтруктураПисьма.Вставить("СписокФайловВложений", Новый Массив);
