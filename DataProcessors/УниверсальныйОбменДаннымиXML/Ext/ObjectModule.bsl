...
//+++АК Susk (Суслин К.В.) 2018.02.13 оптимизация
Перем ОбъектПодключения;
Перем мМассивОбработанныхОСИнполор;
Перем мМассивНеНайденнойНоменклатуры;
Перем мВыводитьПредупреждения;
//---АК Susk (Суслин К.В.)  
...
Процедура ВыполнитьЗагрузку() Экспорт
	...
	//susk
	мМассивОбработанныхОСИнполор = Новый Массив;
	мМассивНеНайденнойНоменклатуры = Новый Массив;
	мВыводитьПредупреждения = Ложь;
...
//+++АК Susk (Суслин К.В.) 2018.09.07 б/н
мМассивОбработанныхОСИнполор = Новый Массив;
мМассивНеНайденнойНоменклатуры = Новый Массив;
мВыводитьПредупреждения = Ложь;
//---АК Susk (Суслин К.В.) 
