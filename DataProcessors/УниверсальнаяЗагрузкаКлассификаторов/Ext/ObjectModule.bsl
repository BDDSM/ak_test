...
Функция ПолучитьКаталогШаблонов() Экспорт
	...
	Если ИдКонфигурации = "БухгалтерияПредприятияКОРП" Тогда
		КаталогШаблоновКонфигурации = "AccountingCorp"
	ИначеЕсли ИдКонфигурации = "БухгалтерияПредприятия" Тогда
		КаталогШаблоновКонфигурации = "Accounting"
	ИначеЕсли ИдКонфигурации = "БухгалтерияПредприятияБазовая" Тогда
		КаталогШаблоновКонфигурации = "AccountingBase"
	КонецЕсли;
