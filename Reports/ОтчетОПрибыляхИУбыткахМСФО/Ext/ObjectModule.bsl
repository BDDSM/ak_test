...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	ИнфокомТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "ОрганизацииКО",   ОрганизацииКО);
	
	//+++ AK suvv 2018.08.29 ИП-00019697
	...
	ИнфокомТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "СписокСтатейИсключений_Инвестиции",   СписокСтатейИсключений_Инвестиции);
	//--- AK suvv
