...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	Если (ПараметрНачалоПериода = Неопределено или ПараметрКонецПериода = Неопределено) и (ПараметрПериод = Неопределено) тогда
		Возврат;
	ИначеЕсли ПараметрНачалоПериода <> Неопределено и ПараметрКонецПериода <> Неопределено Тогда
