...
Функция ПолучитьДанныеДляФормирования(мДатаРаспределения, мРасчетчик, мСклад, ДнейПродажВГруппировке, ГлубинаАнализаПродаж,
										ВыводитьТТМиниТТПусто = Ложь, ВыводитьТолькоВВ = Ложь, ВыводитьДополнительныеСтолбцы = Ложь, ИспользоватьНормативныйКвантДляРасчетаПлановогоОстатка = Истина) Экспорт
