...
Процедура ДоработатьКомпоновщикПередВыводом(ВнешниеНаборыДанных) Экспорт
	...
	ТекущийНаборПоказателей = "" + ПоказателиОтчета.Упр.Значение + ПоказателиОтчета.Корр.Значение  + ПоказателиОтчета.ВалютнаяСумма.Значение + ПоказателиОтчета.Количество.Значение;
	...
	Если ТекущийНаборПоказателей <> мТекущийНаборПоказателей Тогда
		...
		Для Каждого ЭлементМакет Из МассивМакетов Цикл
			СхемаКомпоновкиДанных.Макеты[ЭлементМакет].Макет = АК_СтандартныеОтчеты.ПолучитьКопиюОписанияМакета(СхемаКомпоновкиДанных.Макеты[ЭлементМакет + "Образец"].Макет);
	...
	Если Не ПоказателиОтчета.Упр.Значение Тогда
		...
		Для Каждого ЭлементМассива Из МассивПоказателей Цикл
			Если ЭлементМассива <> "Упр" И ПоказателиОтчета[ЭлементМассива].Значение Тогда
...
Функция ПолучитьТекстЗаголовка(ОрганизацияВНачале = Истина) Экспорт 
	...
	ЗаголовокОтчета = "Карточка счета " + Счет + АК_СтандартныеОтчеты.ПолучитьПредставлениеПериода(ЭтотОбъект);
