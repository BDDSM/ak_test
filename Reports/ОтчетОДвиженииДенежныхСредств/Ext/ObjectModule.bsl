...
мФормыИФорматы = НовоеДеревоФормИФорматов(); //РегламентированнаяОтчетность.

Форма20030101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "710004", '20030722', "67н", "ФормаОтчета2003Кв4");
ОпределитьФорматВДеревеФормИФорматов(Форма20030101, "2.01002", , , , '20081231');
ОпределитьФорматВДеревеФормИФорматов(Форма20030101, "5.02", , , '20100101');
...
НоваяФорма.ФормаОтчета        = "ФормаОтчёта";
НоваяФорма.ОписаниеОтчета     = "Утверждена приказом Минфина России от 22.07.2003 N 67н";
