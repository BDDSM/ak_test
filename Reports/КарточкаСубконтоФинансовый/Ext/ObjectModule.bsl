...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	Для каждого стр Из Субконто Цикл
		...
		ТекстОтбор = ТекстОтбор + ?(ЗначениеЗаполнено(ТекстОтбор), ",", "") + " Субконто"+стр.НомерСтроки+".*";
...
Процедура НачалоВыбораЗначенияСубконто(Элемент, СтандартнаяОбработка, ТипЗначенияПоля=Неопределено) Экспорт
	...
	Для каждого стр из ПостроительОтчета.Отбор Цикл
		...
		Если ЗначениеЗаполнено(ЗначениеОтбора) Тогда
			Если стр.ТипЗначения = ПланыВидовХарактеристик.ВидыСубконто.Товары.ТипЗначения Тогда
				СписокПараметров.Вставить("Номенклатура", ЗначениеОтбора);
			ИначеЕсли стр.ТипЗначения = ПланыВидовХарактеристик.ВидыСубконто.Материалы.ТипЗначения Тогда
				СписокПараметров.Вставить("Номенклатура", ЗначениеОтбора);
			ИначеЕсли стр.ТипЗначения = ПланыВидовХарактеристик.ВидыСубконто.МестаХранения.ТипЗначения Тогда
				СписокПараметров.Вставить("СтруктурныеЕдиницы", ЗначениеОтбора);
			ИначеЕсли стр.ТипЗначения = ПланыВидовХарактеристик.ВидыСубконто.Контрагенты.ТипЗначения Тогда
				СписокПараметров.Вставить("Контрагенты", ЗначениеОтбора);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
