...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	//			   |	Таб.Поставщик,
	//			   |	Таб.Расстояние,
	//			   |	Таб.КоординатыШиротаСтр КАК КоординатыШиротаСтр,
	//			   |	Таб.КоординатыДолготаСтр КАК КоординатыДолготаСтр
	//			   |ПОМЕСТИТЬ ВТ_Данные
	//			   |ИЗ
	//			   |	&Таб КАК Таб
	//			   |;
	...
	//			   |////////////////////////////////////////////////////////////////////////////////
	//			   |ВЫБРАТЬ
	//			   |	ВТ_Данные.ОстатокНаТочке,
	//			   |	ВТ_Данные.Номенклатура КАК Номенклатура,
	//			   |	ВТ_Данные.ТТ КАК ТТ,
	//			   |	ВТ_Данные.Поставщик,
	//			   |	ВТ_Данные.Расстояние КАК Расстояние,
	//			   |	ВТ_Данные.КоординатыШиротаСтр,
	//			   |	ВТ_Данные.КоординатыДолготаСтр
	//			   |ИЗ
	//			   |	ВТ_Данные КАК ВТ_Данные
	//			   |
	//			   |УПОРЯДОЧИТЬ ПО
