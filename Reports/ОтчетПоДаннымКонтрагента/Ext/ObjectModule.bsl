...
Процедура ВывестиДанные(Таб, ПорядковыйНомер, Имя)
	...
	ИначеЕсли Имя = "Договора" Тогда
		...
		//Контактные лица контрагента
		Секция = Макет.ПолучитьОбласть("ШапкаДоговор");
		Секция.Параметры.ПорядковыйНомер = ПорядковыйНомер;
		Таб.Вывести(Секция,1);
		...
		Если Не Результат.Пустой()  Тогда
			...
			Секция = Макет.ПолучитьОбласть("ШапкаДоговорТЧ");
			Таб.Вывести(Секция,2);
		...
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
			...
			Секция = Макет.ПолучитьОбласть("СтрокаДоговора");
			
			Секция.Параметры.Заполнить(ВыборкаДетальныеЗаписи);
			Таб.Вывести(Секция,2);
...
СписокНастроек.Добавить("Договора",    "Договора контрагента"      , Истина);
