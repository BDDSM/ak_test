...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ТаблицаДанных = Отчеты.ОтчетПоЗаказамПоставщикуОбщий1.ПолучитьДанныеДляФормирования(мДатаРаспределения, мРасчетчик, мСклад,
						ЭтотОбъект.ДнейПродажВГруппировке, ЭтотОбъект.ГлубинаАнализа, ЭтотОбъект.ВыводитьТТМиниТТПусто, ЭтотОбъект.ВыводитьТолькоВВ,
						ЭтотОбъект.ВыводитьДополнительныеСтолбцы, ЭтотОбъект.ВсеРаспределения,ЭтотОбъект.ИспользоватьНормативныйКвантДляРасчетаПлановогоОстатка,
