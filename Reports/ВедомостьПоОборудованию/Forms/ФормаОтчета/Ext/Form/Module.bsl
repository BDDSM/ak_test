...
Функция ПолучитьТабличныйДокументРасшифровкаПоРегистраторам(Расшифровка, ОсновноеСредствоСсылка)
	...
	мНачалоПериода 	= мПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("НачалоПериода")).Значение.Дата;
	мКонецПериода 	= мПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("КонецПериода")).Значение.Дата;
	//---susk
