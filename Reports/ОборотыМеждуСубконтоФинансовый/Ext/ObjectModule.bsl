...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	|	"+ТекстПолей+"}", "")+"
	|ИЗ
	|	РегистрБухгалтерии."+ИмяРегистраБухгалтерии+".Обороты(&ДатаНач, &ДатаКон, Период, {Счет.*}, &МассивВидовСубконто, " + ?(Не ПустаяСтрока(ТекстОтбора), "{"+ТекстОтбора+"}", "") + " , {КорСчет.*}, &МассивКорВидовСубконто) КАК Обороты
