...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	СтруктураНомеров = Новый Структура("НомераТелефонаДоверия, НомераДневныхТехнологов, НомераГорячейЛинии, НомераПонедельников, НомераСклад1, НомераСклад2, НомераИнполор",
		"Телефон доверия", "Дневные технологи", "Горячая линия", "Понедельники", "Склад на Кавказском", "Склад на Макарова", "Инполор");
