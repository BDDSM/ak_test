...
Процедура КонтрагентПриИзмененииСервер()
	...
	//---АК POZM 	
		//+++АК SUVV 2018.02.28 ИП-00017941
	    //МассивСчетов = УправлениеДенежнымиСредствами.ПолучитьСчетРасчетовСКонтрагентом(Объект.Контрагент.СтатьяДвиженияДенежныхСредств, Объект.Контрагент);
		МассивСчетов = УправлениеДенежнымиСредствами.ПолучитьСчетРасчетовСКонтрагентом(Объект.Дата, Объект.Контрагент.СтатьяДвиженияДенежныхСредств, Объект.Контрагент);
		//---АК SUVV
