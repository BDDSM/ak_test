...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.МП_ЗадачаТехнолога") Тогда
		...
		Если ДанныеЗаполнения.ТипЗадания <> Перечисления.ТипыЗаданийТехнологаМагазинам.ВозвратНаСклад
		  И ДанныеЗаполнения.ТипЗадания <> Перечисления.ТипыЗаданийТехнологаМагазинам.СписаниеСМагазинов Тогда
			ВызватьИсключение "Документ может вводиться на основании только с видами операций
				|""Возврат на склад"" и ""Списание с магазинов""!";
			Возврат;
		КонецЕсли;
...
Функция ПечатьНакладной() Экспорт
	...
	|	)
	|ИЗ
	|	Документ.ПретензияПоставщику КАК Накладная,
	...
	ТабДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ПретензияПоставщику_Накладная";
