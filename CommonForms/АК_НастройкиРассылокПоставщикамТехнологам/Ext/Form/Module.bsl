...
перем Данные,ТекстОписаниеОшибки,ТестовыйАдрес,ПЛ;

	ПЛ=Пользователи.АвторизованныйПользователь();
	Элементы.о1.Видимость=(ПЛ.Наименование="_тест1") или (ПЛ.Наименование="Верещагин Николай");
	Элементы.о2.Видимость=Элементы.о1.Видимость;
	...
	П=врег(""+Пользователи.АвторизованныйПользователь());
	ВидимостьО=найти(П,"ВЕРЕЩАГИН")>0 или найти(П,"ТЕСТ")>0;
	
	Элементы.о1.Видимость=ВидимостьО;
	Элементы.о2.Видимость=ВидимостьО;
КонецПроцедуры
...
Процедура ОбновитьЗначениеКонстантыНаСервере()
	...
	Данные.Вставить("о1",о1);
	Данные.Вставить("о2",о2);
...
&НаКлиенте
Процедура О1ПриИзменении(Элемент)
	ОбновитьЗначениеКонстанты();
КонецПроцедуры


&НаКлиенте
Процедура О2ПриИзменении(Элемент)
	ОбновитьЗначениеКонстанты();
КонецПроцедуры
